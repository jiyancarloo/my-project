...
export default function Contact() {
  ...
  return (
    <>
      <section id="contact" ref={sectionRef} className=" py-20 bg-[#F4F6FB]">
        <div className="mx-30">
          {/* 1st Column */}
          <div className="grid grid-cols-1 lg:grid-cols-[2fr_2fr] items-center">
            {/* Left Column */}
            <div className="p-8 ">
            ...
            {/* Right Column */}
            <div className="w-full max-w-2xl justify-self-center  flex flex-col ">
