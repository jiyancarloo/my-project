...
export default function TrustedPartners() {
  ...
  return (
    <>
      <section className="px-4 py-12 sm:px-8 lg:px-30 lg:py-20">
        <div className="grid lg:grid-cols-2 place-items-center ">
          {/* Heading */}
          <article className="text-pretty max-w-2xl ">
          ...
          {/* Logos */}
          <div className="flex flex-wrap lg:flex-nowrap  gap-6 sm:gap-8 lg:gap-12">
